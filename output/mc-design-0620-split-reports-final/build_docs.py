...
DOCS = [
    (
        BASE_DIR / "四大系统接口应用基线分析报告.md",
        BASE_DIR / "四大系统接口应用基线分析报告.docx",
    ),
    (
        BASE_DIR / "智能体调用工具持续改进方案.md",
        BASE_DIR / "智能体调用工具持续改进方案.docx",
    ),
    (
        BASE_DIR / "四大系统接口改进阶段性成效报告.md",
        BASE_DIR / "四大系统接口改进阶段性成效报告.docx",
    ),
]
